...
export function HeroSection() {
  return (
    <section className="border-b border-black/10 bg-[#f8f8f7] px-5 pb-16 pt-10 sm:px-8">
      <div className="mx-auto max-w-[1120px]">
        <motion.div
          initial={{ opacity: 0, y: 18 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7, ease: "easeOut" }}
          className="max-w-[710px] pt-8 sm:pt-14"
        >
          <h1 className="landing-pixel-headline font-landing-serif text-[4.2rem] font-semibold leading-[0.88] tracking-[-0.075em] text-[#24211f] sm:text-[5.8rem] lg:text-[6.7rem]">
            Automate your work with natural language
          </h1>
          <p className="mt-8 max-w-[540px] text-[15px] font-medium leading-7 text-[#252525]">
          ...
          <div className="mt-7 flex flex-wrap items-center gap-5">
            <Link
              href={APP_BASE}
              className="inline-flex h-11 items-center justify-center rounded-md bg-[#171717] px-5 text-sm font-semibold text-white shadow-[0_8px_18px_rgba(0,0,0,0.2)] transition hover:-translate-y-0.5"
            >
              Open app
            </Link>
            <Link
              ...
              className="inline-flex h-11 items-center justify-center gap-2 text-sm font-semibold text-stone-700 transition hover:text-stone-950"
            >
              Watch launch video
        ...
        <div className="relative mt-20 overflow-hidden rounded-t-xl border border-black/10 bg-[#d5d7d3] shadow-[0_24px_80px_-50px_rgba(0,0,0,0.35)]">
          <Image
            src="/nectarahero.png"
