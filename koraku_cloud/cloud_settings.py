"""Koraku Cloud product settings (auth, Supabase, Blaxel, automations, channels)."""
...
class CloudSettings(BaseSettings):
    """Cloud server / product configuration. Not part of the PyPI ``koraku`` SDK wheel."""
...
def inert_cloud_settings() -> CloudSettings:
    """Safe defaults when only the SDK layer is active (no product env loaded)."""
